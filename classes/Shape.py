...
class Shape():
    def __init__(self, grid, shapeType, xOffset = constant.SPAWN_X, yOffset = -1):
        ...
        if (shapeType == ShapeType.LINE):
            block1 = Block(self.grid.gridLength, xOffset + 0, yOffset, (66, 134, 244))
            block2 = Block(self.grid.gridLength, xOffset + 1, yOffset, (66, 134, 244))
            block3 = Block(self.grid.gridLength, xOffset + 2, yOffset, (66, 134, 244))
            block4 = Block(self.grid.gridLength, xOffset + 3, yOffset, (66, 134, 244))
